# Smart_AI_partner_churn_predictor
Smart AI Partner Churn Predictor This tool uses a Random Forest model to detect at-risk partners. It calculates a Risk Probability and identifies Churn Drivers to suggest actions. A second Lookup Model retrieves full partner profiles by ID. Built with Python and Scikit-Learn for proactive retention.
...
Predictive Risk Model (The "Forecaster")
...
Partner Insights Model (The "Retriever")
...
Technical Stack Machine Learning: Scikit-Learn (Random Forest) Data Processing: Pandas, NumPy Model Serialization: Joblib (for .pkl deployment) Categorical Encoding: Label Encoding for multi-region and tiered partner types.

Business Impact Traditional churn analysis is often reactive, identifying losses after they occur. This engine focuses on the "At-Risk" window, providing the exact probability and the specific remedy needed to stabilize a partnership.
